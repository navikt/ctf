...
# Connect to the default postgres database to check server availability
# database=None causes libpq to use the username as the database name, which may not exist
